    ...
    <footer style={{
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 400 }}>
          ...
          <p style={{ marginTop: 24, fontSize: 14, color: '#757575' }}>
            Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
          </p>
        </div>
        <div style={{ display: 'flex', flex: 1, alignItems: 'flex-start', justifyContent: 'flex-end', gap: 80 }}>
          <div>
            <h2 style={{ fontWeight: 600, marginBottom: 20, color: '#222' }}>Company</h2>
            <ul style={{ fontSize: 14, listStyle: 'none', padding: 0, margin: 0, color: '#5f6368' }}>
              <li><button type="button" style={{ color: '#5f6368', textDecoration: 'none', background: 'none', border: 'none', padding: 0, cursor: 'pointer', font: 'inherit' }}>Home</button></li>
              <li><button type="button" style={{ color: '#5f6368', textDecoration: 'none', background: 'none', border: 'none', padding: 0, cursor: 'pointer', font: 'inherit' }}>About us</button></li>
              <li><button type="button" style={{ color: '#5f6368', textDecoration: 'none', background: 'none', border: 'none', padding: 0, cursor: 'pointer', font: 'inherit' }}>Contact us</button></li>
              <li><button type="button" style={{ color: '#5f6368', textDecoration: 'none', background: 'none', border: 'none', padding: 0, cursor: 'pointer', font: 'inherit' }}>Privacy policy</button></li>
            </ul>
          </div>
          <div>
            <h2 style={{ fontWeight: 600, marginBottom: 20, color: '#222' }}>Get in touch</h2>
      ...
      <p style={{ paddingTop: 16, textAlign: 'center', fontSize: 13, color: '#888', paddingBottom: 20 }}>
        Copyright 2024 © <a href="https://prebuiltui.com" style={{ color: '#4F39F6', textDecoration: 'none' }}>PrebuiltUI</a>. All Right Reserved.
      </p>
    </footer>
  );
};
